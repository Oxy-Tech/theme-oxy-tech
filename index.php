...
<div class="card mb-3 guideline" style="max-width: 1296px;">
    <div class="row g-0 guideline">
        ...
        <div class="col-md-6 image-align guideline">
            ...
            <img src="
<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/image-1.png" alt="image-1.png">
...
<div class="card mb-3 guideline" style="max-width: 1296px;">
    ...
    <div class="row guideline">
        <div class="col-sm-12 col-md-4 guideline">
            <div class="card">
                <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/article-1.png" class="article-1.png" alt="...">
                <div class="card-body">
        ...
        <div class="col-sm-12 col-md-4 guideline">
            <div class="card">
                <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/article-2.png" class="article-2.png" alt="articles-2">
                <div class="card-body">
                    <h5 class="card-title">
        ...
        <div class="col-sm-12 col-md-4 guideline">
            <div class="card guideline">
                <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/article-3.png" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-sm-12 col-md-10 guideline">
            <div class="parent guideline" id="margin-card">
                <div class="child guideline">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/image-3.png" alt="" class="test">
                </div>
                <div class="child">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/vector.png" alt="">
                </div>
        ...
        <div class="card-text-end pt-5 pb-5 guideline ">
            <div class="card-body-9 card-align d-flex justify-content-between align-items-end card-media">
                ...
                <div class=" guideline card-full-3 autre">
                    ...
                    <div class="row">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/image-weiss-version-desktop/image.png" alt="" class="image">
